...
from endpoints import endtranslate
...
class MSTranslatorAccessKey(object):
    ...
    def expired(self):
        ...
        return datetime.datetime.now() - self.created > timedelta(0, self.expiry)
...
class MSTranslator(object):
    ...
    def translate(self, *args, **kwargs):
        ...
        """
        endpoint = endtranslate.TranslateEndpoint(*args, **kwargs)
        return self.process_endpoint(endpoint)

    def translate_array(self, *args, **kwargs):
        """Translate array from one language to another.

        """

	endpoint = endtranslate.TranslateArrayEndpoint(*args, **kwargs)    
	return self.process_endpoint(endpoint)
